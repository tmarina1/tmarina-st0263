...
Se cumplieron con todos los aspectos propuestos por el profesor para el reto 6-2, se utilizo el dataset propuesto con el fin de manejar y utilizar Spark para el manejo de datos.
